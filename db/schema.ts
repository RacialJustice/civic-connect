...
export const parliamentarySessions = pgTable("parliamentary_sessions", {
  ...
  type: text("type").notNull(), // "regular", "special", "emergency"
  description: text("description"),
...
export const bills = pgTable("bills", {
  ...
  title: text("title").notNull(),
  description: text("description").notNull(),
  status: text("status").notNull(), // "draft", "first_reading", "second_reading", "passed", "rejected"
...
export const developmentProjects = pgTable("development_projects", {
  ...
  status: text("status").notNull(), // "proposed", "approved", "ongoing", "completed"
